...
public class RegistroController {
     ...
     * para que ambos campos muestren la misma contraseña cuando se alterna la
     * visibilidad.
     * Y además, agrega un listener al campo de contraseña para validar su contenido
     * en tiempo real
    ...
    public void initialize() {
        ...
        // Sincronizar el contenido del campo de contraseña visible con el campo de
        // contraseña oculto
    ...
    /**
     * Método que se ejecuta al hacer clic en el botón "Sign up" para registrar un
     * nuevo usuario.
     * Verifica que las contraseñas ingresadas en ambos campos coincidan antes de
     * proceder con el registro del usuario.
     * 
     * @param event Evento que se produce al interactuar con el botón "Sign up".
     */
    @FXML
        ...
        if (!contrasena1.equals(contrasena2)) {
            ...
            if (usuarioService.altaUsuario(Usuario.getText(), contrasena1)) {
                ...
                alert.setContentText(
                        "Por favor, vuelve a intentarlo más tarde o contacta con el soporte si el problema persiste.");
                alert.showAndWait();
            }
            return;
        }
    ...
    /**
     * Método que se ejecuta al hacer clic en el CheckBox para mostrar u ocultar la
     * contraseña.
     * 
     * @param event Evento que se produce al interactuar con el CheckBox
     *              "vBoxPRegistro".
     */
    @FXML
    void VerContrasenia(ActionEvent event) {
        ...
        if (vBoxPRegistro.isSelected()) {
            // Mostrar la contraseña visible y ocultar la contraseña oculta para el primer
            // campo de contraseña
            contraseniaVisible1.setVisible(true);
            contrasenia.setVisible(false);

            // Mostrar la contraseña visible y ocultar la contraseña oculta para el segundo
            // campo de contraseña
            contraseniaVisible2.setVisible(true);
            contrasenia1.setVisible(false);

        } else {
            // Ocultar la contraseña visible y mostrar la contraseña oculta para el primer
            // campo de contraseña
            contraseniaVisible1.setVisible(false);
            contrasenia.setVisible(true);

            // Ocultar la contraseña visible y mostrar la contraseña oculta para el segundo
            // campo de contraseña
            contraseniaVisible2.setVisible(false);
